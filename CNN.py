...
b_conv1 = bias_variable([32]) #The bias value will be added to each filter layer (total 32 layers)
#其实， weight就是conv2d函数中的filter，cnn这个算法就是通过计算最后找到最好的filter去准确分类
...
prediction = tf.nn.softmax(tf.matmul(h_fc1_drop, W_fc2) + b_fc2) #column is 10
